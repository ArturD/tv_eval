...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MatchEvaluation.wrong_episode'
        db.delete_column(u'sony_tv_matchevaluation', 'wrong_episode')

        # Adding field 'MatchEvaluation.wrong_page'
        db.add_column(u'sony_tv_matchevaluation', 'wrong_page',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MatchEvaluation.wrong_episode'
        db.add_column(u'sony_tv_matchevaluation', 'wrong_episode',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'MatchEvaluation.wrong_page'
        db.delete_column(u'sony_tv_matchevaluation', 'wrong_page')
    ...
    models = {
        ...
        u'sony_tv.matchevaluation': {
            ...
            'wrong_page': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
